...
R = 0.5
MAX_DIS = 20
LABEL_DIR = './LD_MX_TestSet_v0.15.0/'
...
class DataEvaluator(object):
    ...
    def load_gt(self, label_path):
        ...
        for anno_file in os.listdir(label_path):
            ...
            info = [0]*len(INFO_LIST) #INFO_LIST = ['Weather', 'Ambient_light', 'Road_state', 'Vehicle_status', 'Interfere', 'Road_form']
            for i in range(len(INFO_LIST)):
            ...
            dataflag = [0]*len(dataList) #the number of gt in this image
            for j in range(len(dataList)):
                ...
                c0 = CATE_LIST.index(label0) #CATE_LIST = ['Ignore','SingleSolid','SingleDotted','DoubleSolid','DoubleDotted','SolidDotted','DottedSolid','Roadline', 'Fence']
    ...
    def acc_segm(self, dir):
        ...
        tp_cate = [0]*len(CATE_LIST) #CATE_LIST = ['Ignore','SingleSolid','SingleDotted','DoubleSolid','DoubleDotted','SolidDotted','DottedSolid','Roadline', 'Fence']
