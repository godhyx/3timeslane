...
class Config:
    def __init__(self):
        ...
        self._configs["warmup_total_iters"] = None
        self._configs["warmup_lr_start"] = None
        self._configs["period"] = None
    ...
    @property
    def period(self):
        return self._configs["period"]

    @property
    def warmup_total_iters(self):
        return self._configs["warmup_total_iters"]

    @property
    def warmup_lr_start(self):
        return self._configs["warmup_lr_start"]
